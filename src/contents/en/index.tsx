...
export const content: Record<ContentId, Content> = {
  ...
  'mcq-2': {
    ...
    post: {
      ...
      mediaUrl: '/images/posts/ifrc/question-02.jpg',
      mediaType: 'image',
    },
    options: [
  ...
  'like-dislike-6': {
    ...
    post: {
      ...
      mediaUrl: '/images/posts/ifrc/question-03.jpg',
      mediaType: 'image',
    },
    correctAnswer: 'dislike',
    whyCorrectAnswer: {
  ...
  'like-dislike-7': {
    ...
    post: {
      ...
      mediaUrl: '/images/posts/ifrc/question-05.jpg',
      mediaType: 'image',
    },
    correctAnswer: 'dislike',
    whyCorrectAnswer: {
  ...
  'mcq-3': {
    ...
    post: {
      ...
      mediaUrl: '/images/posts/ifrc/question-07.jpg',
      mediaType: 'image',
    },
    options: [
  ...
  'like-dislike-8': {
    ...
    post: {
      ...
      mediaUrl: '/images/posts/ifrc/question-08.jpg',
      mediaType: 'image',
    },
    correctAnswer: 'like',
    whyCorrectAnswer: {
